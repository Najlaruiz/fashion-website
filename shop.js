...
function openSingleProductPage(event)
{
  ...
  if (title.match("T-Shirt") == "T-Shirt")
  {
    ...
    srcSmallImg0 = "images/t_purple_sunflower.jpg";
    srcSmallTitle0 = "Purple Pullover T-Shirt";
    srcSmallPrice0 = "₹ 499";

    srcSmallImg1 = "images/t_red_sunflower.jpg";
    srcSmallTitle1 = "Maroon Pullover T-Shirt";
    srcSmallPrice1 = "₹ 559";

    srcSmallImg2 = "images/t_black_sunflower.jpg";
    srcSmallTitle2 = "Black Pullover T-Shirt";
    srcSmallPrice2 = "₹ 399";

    srcSmallImg3 = "images/t_white_sunflower.jpg";
  ...
  else if (title.match("Dress") == "Dress")
  {
    ...
    srcSmallImg0 = "https://i.pinimg.com/474x/6e/cb/f6/6ecbf6e3605af021f531325dc9914c89.jpg";
    srcSmallTitle0 = "Beige Dress";
    srcSmallPrice0 = "₹ 799";

    srcSmallImg1 = "https://i.pinimg.com/236x/b5/ac/b5/b5acb550784135f3bee999c407f6cba2.jpg";
    srcSmallTitle1 = "Red Dress";
    srcSmallPrice1 = "₹ 1299";

    srcSmallImg2 = "https://i.pinimg.com/236x/9e/44/8b/9e448b4fed8b099604df40e4f5632801.jpg";
    srcSmallTitle2 = "White Dress";
    srcSmallPrice2 = "₹ 689";

    srcSmallImg3 = "https://i.pinimg.com/236x/71/99/07/719907035dfc614ce03e695be15a3722.jpg";
    srcSmallTitle3 = "Marron Dress";
    srcSmallPrice3 = "₹ 829";
  ...
  else if (title.match("Jeans") == "Jeans")
  {
    ...
    srcSmallImg0 = "images/jeans_brown_4.jpg";
    srcSmallTitle0 = "Brown Wide Leg Jeans";
    srcSmallPrice0 = "₹ 689";

    srcSmallImg1 = "images/jeans_black_5.jpg";
    srcSmallTitle1 = "Black Regular-Fit Jeans";
    srcSmallPrice1 = "₹ 799";

    srcSmallImg2 = "images/jeans_blue_2.jpg";
    srcSmallTitle2 = "Denim Blue Flared Jeans";
    srcSmallPrice2 = "₹ 739";

    srcSmallImg3 = "images/jeans_white_3.jpg";
  ...
  else if (title.match("Bag") == "Bag")
  {
    ...
    srcSmallImg0 = "images/bag_3.jpg";
    srcSmallTitle0 = "Choco-Brown Shoulder Bag";
    srcSmallPrice0 = "₹ 999";

    srcSmallImg1 = "images/bag_4.jpg";
    srcSmallTitle1 = "SkyBlue Shoulder Bag";
    srcSmallPrice1 = "₹ 1899";

    srcSmallImg2 = "images/bag_6.jpg";
    srcSmallTitle2 = "Red Shoulder Bag";
    srcSmallPrice2 = "₹ 699";

    srcSmallImg3 = "images/bag_5.jpg";
  ...
  else if (title.match("Lipstick") == "Lipstick")
  {
    ...
    srcSmallImg0 = "images/lipstick_3.jpg";
    srcSmallTitle0 = "Pink Cream Lipstick";
    srcSmallPrice0 = "₹ 599";

    srcSmallImg1 = "images/lipstick_1.jpg";
    srcSmallTitle1 = "Nude Cream Lipstick";
    srcSmallPrice1 = "₹ 799";

    srcSmallImg2 = "images/lipstick_4.jpg";
    srcSmallTitle2 = "Red Cream Lipstick";
    srcSmallPrice2 = "₹ 999";

    srcSmallImg3 = "images/lipstick_2.jpg";
  ...
  else if (title.match("Heels") == "Heels")
  {
    ...
    srcSmallImg0 = "images/heels_3.jpg";
    srcSmallTitle0 = "Brown Kitten Heels";
    srcSmallPrice0 = "₹ 1299";

    srcSmallImg1 = "images/heels_2.jpg";
    srcSmallTitle1 = "Black Pencil Heels";
    srcSmallPrice1 = "₹ 899";

    srcSmallImg2 = "images/heels_1.jpg";
    srcSmallTitle2 = "Beige Block Heels";
    srcSmallPrice2 = "₹ 799";

    srcSmallImg3 = "images/heels_4.jpg";
